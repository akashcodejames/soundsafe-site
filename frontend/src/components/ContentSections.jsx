...
function ContentBlock({ section }) {
  ...
  if (section.layout === "split" && imageCol) {
    return (
      <article className="content-block content-block--split content-block--feature card-fx surface-card">
        {imageCol}
        {textCol}
      </article>
    );
  ...
  if (section.layout === "split-reverse" && imageCol) {
    return (
      <article className="content-block content-block--split content-block--feature card-fx reverse surface-card">
        {textCol}
        {imageCol}
      </article>
    );
  ...
  return (
    <article className="content-block content-block--stack content-block--feature card-fx surface-card surface-card--signal">
      {imageCol}
      {textCol}
    </article>
  );
